...
'[gokulnathkumaresan03@gmail.com](mailto:gokulnathkumaresan03@gmail.com)'
)
.trim()
.toLowerCase();
...
const teamId =
cookies.kgh_event_team;

const token =
cookies.kgh_event_token;
...
```
  try {
    ...
    if (
      ...
      /*
         /round will be added when we build
         the actual round interface.
      */
